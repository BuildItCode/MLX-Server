...
# This installs the launcher (command: omnicode) and best-effort fetches a prebuilt llama-server.exe.
#
...
Write-Host ""
Write-Host "Done. Start it from a new terminal with:  omnicode"
