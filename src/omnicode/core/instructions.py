...
independent of any frontend. :func:`omnicode.core.messages.build_openai_messages` folds the
...
CODING_MODE_INSTRUCTIONS = (
    ...
    "website, a script, a component — write the files, don't describe them.\n"
    "- When calling browser tools, pass ONLY the parameters you actually need — optional "
    "parameters must be omitted entirely, never sent as null. And never hand-build file:// "
    "URLs for the browser: to preview a file from the working directory, call "
    "open_in_browser with the RELATIVE path (e.g. \"index.html\").\n"
