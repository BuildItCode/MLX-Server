...
class OmniCodeApp(App):
    TITLE = "omnicode"
    SUB_TITLE = "omnicode"

    CSS = """
    Header { text-style: none; }
    HeaderTitle { text-style: none; }
    ...
    #sidebar-head { height: 3; padding: 0 1; align-vertical: middle; }
    #sidebar-head .section { width: 1fr; padding: 0 1 0 0; }
    #sidebar-head .icon-btn { height: 3; width: 6; min-width: 6; padding: 0; }
    ...
    #chat-topbar { height: 3; padding: 0 0 0 1; align-vertical: middle; }
    .icon-btn { width: 6; height: 3; min-width: 6; padding: 0; margin: 0; border: none; color: $text-muted; background: $panel; }
    .icon-btn:hover { color: $text; background: $surface; }
    #server-select { width: 34; height: 3; margin: 0 0 0 1; }
    #skill-select { width: 40; height: 3; margin: 0 0 0 1; }
    #folder-btn { height: 3; width: 6; min-width: 6; max-width: 24; margin: 0; padding: 0; border: none; color: $accent; background: $panel; }
    #folder-btn:hover { color: $text; background: $surface; }
    #folder-btn.has-folder { width: auto; min-width: 6; padding: 0 1; }
    ...
    #mic-stack { width: 12; height: auto; }
    #mic-stack Button { width: 1fr; min-width: 0; height: 3; padding: 0 1; margin: 0; }
    #mic-stack Button:first-child { margin-bottom: 0; }
    ...
    async def backend(self):
        ...
        ``omnicode-backend`` on first use. The frontend reaches the backend ONLY through this client."""
    ...
    def on_mount(self) -> None:
        ...
        # Spawning/discovering omnicode-backend can take a second or two; loading config behind
